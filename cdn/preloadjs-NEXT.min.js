...
d=null;if(b&&window.XDomainRequest)d=new XDomainRequest;else if(window.XMLHttpRequest)d=new XMLHttpRequest;else try{d=new ActiveXObject("Msxml2.XMLHTTP.6.0")}catch(h){try{d=new ActiveXObject("Msxml2.XMLHTTP.3.0")}catch(m){try{d=new ActiveXObject("Msxml2.XMLHTTP")}catch(f){return false}}}a.type==createjs.LoadQueue.TEXT&&d.overrideMimeType&&d.overrideMimeType("text/plain; charset=utf-8");this._xhrLevel=typeof d.responseType==="string"?2:1;var j=null,j=a.method==createjs.LoadQueue.GET?this.buildPath(a.src,
